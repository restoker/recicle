...
const logos = [
  { name: 'Transistor', url: 'https://tailwindcss.com/plus-assets/img/logos/158x48/transistor-logo-white.svg' },
  { name: 'Reform', url: 'https://tailwindcss.com/plus-assets/img/logos/158x48/reform-logo-white.svg' },
  { name: 'Tuple', url: 'https://tailwindcss.com/plus-assets/img/logos/158x48/tuple-logo-white.svg' },
  { name: 'SavvyCal', url: 'https://tailwindcss.com/plus-assets/img/logos/158x48/savvycal-logo-white.svg' },
  { name: 'Statamic', url: 'https://tailwindcss.com/plus-assets/img/logos/158x48/statamic-logo-white.svg' },
                  ...
                  <form action="#" className="mt-12 sm:flex sm:w-full sm:max-w-lg">
                    <div className="min-w-0 flex-1">
                      ...
                      <input
                        id="hero-email"
                        type="email"
                        className="block w-full rounded-md border border-gray-300 px-5 py-3 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-lime-500 focus:ring-lime-500"
                    ...
                    <div className="mt-4 sm:mt-0 sm:ml-3">
                      <button
                        type="submit"
                        className="block w-full rounded-md border border-transparent bg-lime-500 px-5 py-3 text-base font-medium text-white shadow hover:bg-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2 sm:px-10"
                      >
                        Notify me
                      </button>
                    </div>
                  ...
                  <div className="mt-6">
                    <div className="inline-flex items-center divide-x divide-gray-300">
                      ...
                      <div className="min-w-0 flex-1 py-1 pl-5 text-sm text-gray-500 sm:py-3">
                        ...
                        <span className="font-medium text-lime-500">500 beta users</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="sm:mx-auto sm:max-w-3xl sm:px-6">
              <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                ...
                <div className="relative -mr-40 pl-6 sm:mx-auto sm:max-w-3xl sm:px-0 lg:h-full lg:max-w-none lg:pl-12">
                  {/* <img
                    className="w-full rounded-md shadow-xl ring-1 ring-black/20 ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none"
            ...
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
                ...
                <div className="relative mx-auto max-w-md px-6 sm:max-w-3xl lg:max-w-none lg:px-0 lg:py-20">
                  ...
                  <div className="relative overflow-hidden rounded-2xl pt-64 pb-10 shadow-xl">
                    <img
                      ...
                      alt=""
                    />
                    <div className="absolute inset-0 bg-lime-50/10 mix-blend-multiply" />
                    <div className="absolute inset-0 bg-gradient-to-t from-lime-600/20 via-lime-600/20 opacity-90" />
              ...
              <div className="relative mx-auto max-w-md px-6 sm:max-w-3xl lg:px-0">
                ...
                <div className="mt-10">
                  ...
                  <div className="mt-10">
                    <a href="#" className="text-base font-medium text-lime-500">
              ...
              <div className="relative overflow-hidden rounded-2xl bg-lime-50 px-6 py-10 shadow-xl sm:px-12 sm:py-20">
                ...
                <div className="relative z-20">
                  <div className="sm:text-center mix-blend-difference">
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-lime-100">
                      Sagittis scelerisque nulla cursus in enim consectetur quam. Dictum urna sed consectetur neque
                  ...
                  <form action="#" className="mt-12 sm:mx-auto sm:flex sm:max-w-lg">
                    <div className="min-w-0 flex-1">
                      ...
                      <input
                        id="cta-email"
                        type="email"
                        className="block w-full rounded-md border border-transparent px-5 py-3 text-base text-white placeholder-gray-200 shadow-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-lime-500 backdrop-blur-2xl bg-white/10"
                        placeholder="Enter your email"
                      />
                    </div>
                    <div className="mt-4 sm:mt-0 sm:ml-3">
